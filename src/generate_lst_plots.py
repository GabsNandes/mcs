...
def process_file(file_path):
    output = "data/processed/lst/figs"; os.makedirs(output, exist_ok=True)
    ...
    data = np.load(file_path)['avg']
    
    ref_file_path = 'data/raw/lst/OR_ABI-L2-LSTF-M6_G16_s20230010000206_e20230010009514_c20230010011292.nc'
    img = gdal.Open(f'NETCDF:{ref_file_path}:LST')
    ...
    # Plot the image
    img = ax.imshow(reprojected_data, vmin=10, vmax=40, cmap='jet', origin='upper', extent=img_extent)
