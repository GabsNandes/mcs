...
def download_adp_data(date, path):
    product = "ABI-L2-ADPF"
...
def main():
    parser = argparse.ArgumentParser(description="Download ABI-L2-ADP product from GOES-16 for a date")
    parser.add_argument("date", help="Date in yyyymmdd format")
    parser.add_argument("path", help="Destination path, default is data/raw", default="data/raw/adp")
    ...
    download_adp_data(args.date, args.path)
