# Plot AOD data with a CMI background image
...
adp_dir = "data/raw/aod/20220202"
processed_dir = "data/processed/aod"
...
for adp_file in adp_files:
    ...
    aod = file_adp.variables['AOD'][:] * 1000
    ae1 = file_adp.variables['AE1'][:] * 1000
    ae2 = file_adp.variables['AE2'][:] * 1000   
    ...
    ax.imshow(aod, extent=img_extent, cmap='jet', alpha=1, origin='upper')
    ax.imshow(ae1, extent=img_extent, cmap='viridis', alpha=1, origin='upper')
    ax.imshow(ae2, extent=img_extent, cmap='ocean', alpha=1, origin='upper')    
